...
(function(e, t) {
    ...
    r = x(a),
    function(e, t) {
        var n, r, i, o, a, s, l, u, c, p, f, d, h, g, m, y, v, b = "sizzle" + -new Date, w = e.document, T = 0, C = 0, N = ae(), k = ae(), E = ae(), S = !1, A = function(e, t) {
            return e === t ? (S = !0,
            0) : 0
            ...
            if (h && !i) {
                ...
                if (r.qsa && (!g || !g.test(e))) {
                    ...
                    1 === l && "object" !== t.nodeName.toLowerCase()) {
                        c = ge(e),
                        (d = t.getAttribute("id")) ? m = d.replace(ne, "\\$&") : t.setAttribute("id", m),
                        m = "[id='" + m + "'] ",
                        u = c.length;
                        while (u--)
                            c[u] = m + me(c[u]);
        ...
        p = oe.setDocument = function(e) {
            ...
            m = [],
            g = [],
            (r.qsa = K.test(n.querySelectorAll)) && (le(function(e) {
            ...
            : function(e, t) {
                ...
                while (s[i] === l[i])
                    i++;
                return i ? ce(s[i], l[i]) : s[i] === w ? -1 : l[i] === w ? 1 : 0
            }
            ,
            n) : f
        }
        ...
        function xe(e, t, n, r, i, o) {
            ...
            i && !i[b] && (i = xe(i, o)),
            se(function(o, a, s, l) {
                var u, c, p, f = [], d = [], h = a.length, g = o || Ce(t || "*", s.nodeType ? [s] : s, []), m = !e || !o && t ? g : be(g, f, e, s, l), y = n ? i || (o ? e : h || r) ? [] : a : m;
                if (n && n(m, y, s, l),
                r) {
                    u = be(y, d),
                    r(u, [], s, l),
        ...
        function we(e) {
            var t, n, r, i = e.length, a = o.relative[e[0].type], s = a || o.relative[" "], l = a ? 1 : 0, c = ye(function(e) {
                return e === t
            }, s, !0), p = ye(function(e) {
                return F.call(t, e) > -1
                    ...
                    n[b]) {
                        for (r = ++l; i > r; r++)
                            if (o.relative[e[r].type])
                                break;
                        return xe(l > 1 && ve(f), l > 1 && me(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(z, "$1"), n, r > l && we(e.slice(l, r)), i > r && we(e = e.slice(r)), i > r && me(e))
                    }
                    f.push(n)
                }
            return ve(f)
            ...
            var n = 0
              ...
              , s = function(s, l, c, p, d) {
                ...
                r && b !== v) {
                    ...
                    M.apply(p, y),
                    w && !s && y.length > 0 && v + t.length > 1 && oe.uniqueSort(p)
                }
                return w && (T = k,
                u = C),
                x
        ...
        function Ne(e, t, n, i) {
            ...
            if (!i && 1 === f.length) {
                ...
                while (a--) {
                    ...
                    o.relative[c = u.type])
                        break;
                    if ((p = o.find[c]) && (i = p(u.matches[0].replace(re, ie), V.test(s[0].type) && t.parentNode || t))) {
                        if (s.splice(a, 1),
                        e = i.length && me(s),
                        !e)
                            return M.apply(n, i),
    ...
    x.event = {
        ...
        trigger: function(n, r, i, o) {
            ...
            if (u = f = i = i || a,
            3 !== i.nodeType && 8 !== i.nodeType && !ne.test(g + x.event.triggered) && (g.indexOf(".") >= 0 && (m = g.split("."),
            g = m.shift(),
            m.sort()),
            l = 0 > g.indexOf(":") && "on" + g,
            ...
            o || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                if (!o && !p.noBubble && !x.isWindow(i)) {
                    ...
                    ne.test(c + g) || (u = u.parentNode); u; u = u.parentNode)
                        h.push(u),
                        f = u;
    ...
    x.Event = function(e, n) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? ie : oe) : this.type = e,
        n && x.extend(this, n),
    ...
    x.fn.extend({
        ...
        is: function(e) {
            return !!fe(this, "string" == typeof e && ue.test(e) ? x(e) : e || [], !1).length
        },
        closest: function(e, t) {
            var n, r = 0, i = this.length, o = [], a = ue.test(e) || "string" != typeof e ? x(e, t || this.context) : 0;
            for (; i > r; r++)
    ...
    x.each({
        ...
        x.fn[e] = function(n, r) {
            ...
            this.length > 1 && (ce[e] || (i = x.unique(i)),
    ...
    var he = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
      ...
      , je = de(a)
      , De = je.appendChild(a.createElement("div"));
    ...
    x.fn.extend({
        ...
        remove: function(e, t) {
            ...
            for (; null != (n = r[i]); i++)
                t || 1 !== n.nodeType || x.cleanData(Fe(n)),
                n.parentNode && (t && x.contains(n.ownerDocument, n) && _e(Fe(n, "script")),
        ...
        html: function(e) {
            return x.access(this, function(e) {
                var n = this[0] || {}
                  ...
                  , i = this.length;
                if (e === t)
                    return 1 === n.nodeType ? n.innerHTML.replace(ge, "") : t;
                if (!("string" != typeof e || Te.test(e) || !x.support.htmlSerialize && me.test(e) || !x.support.leadingWhitespace && ye.test(e) || Ae[(be.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(ve, "<$1></$2>");
                    try {
                        for (; i > r; r++)
                            n = this[r] || {},
                            1 === n.nodeType && (x.cleanData(Fe(n, !1)),
                            n.innerHTML = e);
                        n = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t, n) {
            ...
            if (g || !(1 >= c || "string" != typeof h || x.support.checkClone) && Ne.test(h))
            ...
            r)) {
                for (a = x.map(Fe(l, "script"), He),
                o = a.length; c > u; u++)
                    i = l,
                    u !== f && (i = x.clone(i, !0, !0),
                    o && x.merge(a, Fe(i, "script"))),
                    t.call(this[u], i, u);
                if (o)
                    ...
                    u = 0; o > u; u++)
                        i = a[u],
                        ke.test(i.type || "") && !x._data(i, "globalEval") && x.contains(s, i) && (i.src ? x._evalUrl(i.src) : x.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Se, "")));
                l = r = null
            }
            return this
        }
    ...
    function Oe(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text ? (He(t).text = e.text,
            qe(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML),
            x.support.html5Clone && e.innerHTML && !x.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ce.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function Fe(e, n) {
        ...
        if (!s)
            ...
            r = e.childNodes || e; null != (o = r[a]); a++)
                !n || x.nodeName(o, n) ? s.push(o) : x.merge(s, Fe(o, n));
    ...
    x.extend({
        clone: function(e, t, n) {
            ...
            if (x.support.html5Clone || x.isXMLDoc(e) || !me.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (De.innerHTML = e.outerHTML,
            ...
            if (t)
                if (n)
                    ...
                    Me(e, o);
            return r = Fe(o, "script"),
            r.length > 0 && _e(r, !l && Fe(e, "script")),
            r = s = i = null,
            o
        },
        buildFragment: function(e, t, n, r) {
            var i, o, a, s, l, u, c, p = e.length, f = de(t), d = [], h = 0;
            for (; p > h; h++)
                if (o = e[h],
                o || 0 === o)
                    if ("object" === x.type(o))
                        ...
                        c = Ae[l] || Ae._default,
                        s.innerHTML = c[1] + o.replace(ve, "<$1></$2>") + c[2],
                        i = c[0];
                        while (i--)
                            s = s.lastChild;
                        if (!x.support.leadingWhitespace && ye.test(o) && d.push(t.createTextNode(ye.exec(o)[0])),
                        !x.support.tbody) {
                            o = "table" !== l || xe.test(o) ? "<table>" !== c[1] || xe.test(o) ? 0 : s : s.firstChild,
            ...
            s && f.removeChild(s),
            x.support.appendChecked || x.grep(Fe(d, "input"), Be),
            h = 0;
            while (o = d[h++])
                if ((!r || -1 === x.inArray(o, r)) && (a = x.contains(o.ownerDocument, o),
                s = Fe(f.appendChild(o), "script"),
                a && _e(s),
                n)) {
                    i = 0;
                    while (o = s[i++])
    ...
    var Pe, Re, We, $e = /alpha\([^)]*\)/i, Ie = /opacity\s*=\s*([^)]*)/, ze = /^(top|right|bottom|left)$/, Xe = /^(none|table(?!-c[ea]).+)/, Ue = /^margin/, Ve = RegExp("^(" + w + ")(.*)$", "i"), Ye = RegExp("^(" + w + ")(?!px)[a-z%]+$", "i"), Je = RegExp("^([+-])=(" + w + ")", "i"), Ge = {
        BODY: "block"
    }, Qe = {
        position: "absolute",
        visibility: "hidden",
        ...
        letterSpacing: 0,
        fontWeight: 400
    }, Ze = ["Top", "Right", "Bottom", "Left"], et = ["Webkit", "O", "Moz", "ms"];
    function tt(e, t) {
        if (t in e)
            return t;
    ...
    function rt(e, t) {
        ...
        for (; s > a; a++)
            ...
            "" === r.style.display && nt(r) && (o[a] = x._data(r, "olddisplay", st(r.nodeName)))) : o[a] || (i = nt(r),
    ...
    x.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = x.cssProps[l] || (x.cssProps[l] = tt(u, l)),
                s = x.cssHooks[n] || x.cssHooks[l],
                r === t)
                    return s && "get"in s && (o = s.get(e, !1, i)) !== t ? o : u[n];
                if (a = typeof r,
                "string" === a && (o = Je.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(x.css(e, n)),
                a = "number"),
        ...
        css: function(e, n, r, i) {
            ...
            return n = x.cssProps[l] || (x.cssProps[l] = tt(e.style, l)),
            s = x.cssHooks[n] || x.cssHooks[l],
    ...
    ,
    We = function(e, n, r) {
        var i, o, a, s = r || Re(e), l = s ? s.getPropertyValue(n) || s[n] : t, u = e.style;
        return s && ("" !== l || x.contains(e.ownerDocument, e) || (l = x.style(e, n)),
        Ye.test(l) && Ue.test(n) && (i = u.width,
        o = u.minWidth,
        a = u.maxWidth,
    ...
    ) : a.documentElement.currentStyle && (Re = function(e) {
        return e.currentStyle
    }
    ,
    We = function(e, n, r) {
        var i, o, a, s = r || Re(e), l = s ? s[n] : t, u = e.style;
        return null == l && u && u[n] && (l = u[n]),
        Ye.test(l) && !ze.test(n) && (i = u.left,
        o = e.runtimeStyle,
        a = o && o.left,
    ...
    function ot(e, t, n, r, i) {
        var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0
          , a = 0;
        for (; 4 > o; o += 2)
            "margin" === n && (a += x.css(e, n + Ze[o], !0, i)),
            r ? ("content" === n && (a -= x.css(e, "padding" + Ze[o], !0, i)),
            "margin" !== n && (a -= x.css(e, "border" + Ze[o] + "Width", !0, i))) : (a += x.css(e, "padding" + Ze[o], !0, i),
            "padding" !== n && (a += x.css(e, "border" + Ze[o] + "Width", !0, i)));
        return a
    }
    function at(e, t, n) {
        var r = !0
    ...
    function st(e) {
        var t = a
          , n = Ge[e];
        return n || (n = lt(e, t),
        "none" !== n && n || (Pe = (Pe || x("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
    ...
    x.each(["height", "width"], function(e, n) {
        x.cssHooks[n] = {
            get: function(e, r, i) {
                return r ? 0 === e.offsetWidth && Xe.test(x.css(e, "display")) ? x.swap(e, Qe, function() {
                    return at(e, n, i)
                }) : at(e, n, i) : t
            },
            set: function(e, t, r) {
                var i = r && Re(e);
                return it(e, t, r ? ot(e, n, r, x.support.boxSizing && "border-box" === x.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }),
    x.support.opacity || (x.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === x.trim(o.replace($e, "")) && n.removeAttribute && (n.removeAttribute("filter"),
            "" === t || r && !r.filter) || (n.filter = $e.test(o) ? o.replace($e, i) : o + " " + i)
        }
    }),
    x(function() {
        ...
        !x.support.pixelPosition && x.fn.position && x.each(["top", "left"], function(e, n) {
            x.cssHooks[n] = {
                get: function(e, r) {
                    return r ? (r = We(e, n),
                    Ye.test(r) ? x(e).position()[n] + "px" : r) : t
                }
            }
        })
    }),
    ...
    x.each({
        ...
        Ue.test(e) || (x.cssHooks[e + t].set = it)
    });
    var ut = /%20/g
      , ct = /\[\]$/
      , pt = /\r?\n/g
    ...
    x.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && dt.test(this.nodeName) && !ft.test(e) && (this.checked || !Ce.test(e))
            }).map(function(e, t) {
                var n = x(this).val();
    ...
    function ht(e, t, n, r) {
        ...
        if (x.isArray(t))
            x.each(t, function(t, i) {
                n || ct.test(e) ? r(e, i) : ht(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
            });
    ...
    var gt, mt, yt = x.now(), vt = /\?/, bt = /#.*$/, xt = /([?&])_=[^&]*/, wt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Tt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ct = /^(?:GET|HEAD)$/, Nt = /^\/\//, kt = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Et = x.fn.load, St = {}, At = {}, jt = "*/".concat("*");
    try {
        mt = o.href
    } catch (e) {
    ...
    x.extend({
        ...
        ajax: function(e, n) {
            ...
            C.success = C.done,
            C.error = C.fail,
            p.url = ((e || p.url || mt) + "").replace(bt, "").replace(Nt, gt[1] + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = x.trim(p.dataType || "*").toLowerCase().match(T) || [""],
            null == p.crossDomain && (r = kt.exec(p.url.toLowerCase()),
            p.crossDomain = !(!r || r[1] === gt[1] && r[2] === gt[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (gt[3] || ("http:" === gt[1] ? "80" : "443")))),
    ...
    x.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Mt.pop() || x.expando + "_" + yt++;
            return this[e] = !0,
            e
        }
    }),
    x.ajaxPrefilter("json jsonp", function(n, r, i) {
        var o, a, s, l = n.jsonp !== !1 && (Ot.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Ot.test(n.data) && "data");
        return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = x.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
        l ? n[l] = n[l].replace(Ot, "$1" + o) : n.jsonp !== !1 && (n.url += (vt.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
    ...
    var Ft, Bt, Pt = 0, Rt = e.ActiveXObject && function() {
        var e;
        for (e in Ft)
            Ft[e](t, !0)
    }
    ...
    x.ajaxSettings.xhr = e.ActiveXObject ? function() {
        return !this.isLocal && Wt() || $t()
    }
    : Wt,
    Bt = x.ajaxSettings.xhr(),
    x.support.cors = !!Bt && "withCredentials"in Bt,
    Bt = x.support.ajax = !!Bt,
    Bt && x.ajaxTransport(function(n) {
        if (!n.crossDomain || x.support.cors) {
            ...
            return {
                send: function(i, o) {
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(r) : (a = ++Pt,
                    Rt && (Ft || (Ft = {},
                    x(e).unload(Rt)),
                    Ft[a] = r),
    ...
    var It, zt, Xt = /^(?:toggle|show|hide)$/, Ut = RegExp("^(?:([+-])=|)(" + w + ")([a-z%]*)$", "i"), Vt = /queueHooks$/, Yt = [en], Jt = {
        "*": [function(e, t) {
            var n = this.createTween(e, t)
              , r = n.cur()
              , i = Ut.exec(t)
              , o = i && i[3] || (x.cssNumber[e] ? "" : "px")
              , a = (x.cssNumber[e] || "px" !== o && +r) && Ut.exec(x.css(n.elem, e))
              , s = 1
              , l = 20;
            if (a && a[3] !== o) {
                o = o || a[3],
    ...
    function Qt(e, t, n) {
        var r, i = (Jt[t] || []).concat(Jt["*"]), o = 0, a = i.length;
        for (; a > o; o++)
            if (r = i[o].call(n, t, e))
                return r
    }
    function Kt(e, t, n) {
        var r, i, o = 0, a = Yt.length, s = x.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (i)
                return !1;
        ...
        for (Zt(c, u.opts.specialEasing); a > o; o++)
    ...
    function en(e, t, n) {
        var r, i, o, a, s, l, u = this, c = {}, p = e.style, f = e.nodeType && nt(e), d = x._data(e, "fxshow");
        ...
        "inline" === x.css(e, "display") && "none" === x.css(e, "float") && (x.support.inlineBlockNeedsLayout && "inline" !== st(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
    ...
    function tn(e, t, n, r, i) {
        return new tn.prototype.init(e,t,n,r,i)
    }
    x.Tween = tn,
    tn.prototype = {
        constructor: tn,
        ...
        cur: function() {
            var e = tn.propHooks[this.prop];
            return e && e.get ? e.get(this) : tn.propHooks._default.get(this)
        },
        run: function(e) {
            var t, n = tn.propHooks[this.prop];
            return this.pos = t = this.options.duration ? x.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e,
            this.now = (this.end - this.start) * t + this.start,
            this.options.step && this.options.step.call(this.elem, this.now, this),
            n && n.set ? n.set(this) : tn.propHooks._default.set(this),
            this
        }
    },
    tn.prototype.init.prototype = tn.prototype,
    tn.propHooks = {
        _default: {
            get: function(e) {
                var t;
    ...
    tn.propHooks.scrollTop = tn.propHooks.scrollLeft = {
        set: function(e) {
    ...
    x.each(["toggle", "show", "hide"], function(e, t) {
        ...
        x.fn[t] = function(e, r, i) {
            return null == e || "boolean" == typeof e ? n.apply(this, arguments) : this.animate(nn(t, !0), e, r, i)
        }
    }),
    x.fn.extend({
    ...
    x.timers = [],
    x.fx = tn.prototype.init,
    x.fx.tick = function() {
        var e, n = x.timers, r = 0;
        for (It = x.now(); n.length > r; r++)
            e = n[r],
