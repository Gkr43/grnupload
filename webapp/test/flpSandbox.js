					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GRP Upload App",
									"targetURL": "#grnupload-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"grnupload-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=grnupload",
									"url": sap.ui.require.toUrl("grnupload")
								}
							}
						}
					}
